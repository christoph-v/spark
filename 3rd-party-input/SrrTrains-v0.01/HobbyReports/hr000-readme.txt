...
================================================================================
The stable version of the Hobby Reports of SrrTrains v0.01 - version 3.x - can
be found in branch "stable_33.10" of the present repository.

The stable version of the SRR Framework (step 0033.10 "Pieta") can be downloaded
as .zip file from https://sourceforge.net/projects/simulrr/files/
================================================================================

================================================================================
The Hobby Reports are now being provided for version 4.3 (which should provide a
view to the "Arimathea" release (step 0033.11), as it is currently envisioned)
in the "master" branch of the present repository.
    - items to be done for "Arimathea" are marked by a tag "TODO11"
    - items to be done for step 0033.12 are marked by a tag "TODO12"
...
---------------------------------------------
   ...
   Current version is 4.3, where no substantial changes are expected between
   step 0033.10 and step 0033.11.
...
--------------------------
   ...
   Current version is 4.3, it will not be updated again (it's a "snapshot")
...
------------------------------------------------
   ...
   new version will be either 3.1 (if LAN Party #3 will base on Step 0033.10)
   or 4.1 (if LAN Party #3 will base on Step 0033.11)
...
------------------------------
   ...
   Current version is 4.3, it'll be updated, when step 0033.11 will be finished
